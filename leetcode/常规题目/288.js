/*
 * @Author: xiaohuolong
 * @Date: 2021-08-11 16:52:17
 * @LastEditors: xiaohuolong
 * @LastEditTime: 2021-08-11 16:53:04
 * @FilePath: /js-demo/leetcode/常规题目/288.js
 */
/*
单词的唯一缩写
...
var ValidWordAbbr = function(dictionary) {
    ...
    dictionary.forEach(item => {
        this.set(this.calculWord(item), item)
    })
};
...
ValidWordAbbr.prototype.isUnique = function(word) {
    let key = this.calculWord(word)
    let flag = !this.dict[key] || (this.dict[key][word] && Object.keys(this.dict[key]).length === 1)
    return !!flag
};
 ...
 * @return {boolean}
 */
ValidWordAbbr.prototype.calculWord = function(word) {
 ...
 * @return {boolean}
 */
ValidWordAbbr.prototype.set = function(str, word) {
    if(!this.dict[str]){
        this.dict[str] = {}
    }
    this.dict[str][word] = true
};
